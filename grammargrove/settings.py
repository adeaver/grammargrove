"""
Django settings for grammargrove project.
...
if os.environ.get("ENV", "prod") == "prod":
    ...
    DEBUG = False
    ALLOWED_HOSTS = ["www.grammargrove.com", "grammargrove.com"]
...
ROOT_URLCONF = 'grammargrove.urls'
...
WSGI_APPLICATION = 'grammargrove.wsgi.application'
