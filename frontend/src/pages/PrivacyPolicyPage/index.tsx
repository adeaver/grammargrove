            ...
            <div class="w-full flex flex-col items-center">
                <div class="py-6 max-w-2xl space-y-4">
                    <Text type={TextType.FinePrint} alignment={TextAlignment.Left}>
                        Grammar Grove Privacy Policy.
                    </Text>
                    <Text type={TextType.FinePrint} alignment={TextAlignment.Left}>
                        Last updated: 2023-07-12
                    </Text>
                    <Text alignment={TextAlignment.Left}>
                        This Privacy Policy describes how Grammar Grove (the "Site", "we", "us", or "our") collects, uses, and discloses your personal information when you visit, use our services, or make a purchase from grammargrove.com (the "Site") or otherwise communicate with us (collectively, the "Services"). For purposes of this Privacy Policy, "you" and "your" means you as the user of the Services, whether you are a customer, website visitor, or another individual whose information we have collected pursuant to this Privacy Policy.
                    </Text>
                    <Text alignment={TextAlignment.Left}>
                        Please read this Privacy Policy carefully. By using and accessing any of the Services, you agree to the collection, use, and disclosure of your information as described in this Privacy Policy. If you do not agree to this Privacy Policy, please do not use or access any of the Services.
                    </Text>
                    <Text type={TextType.SectionHeader} alignment={TextAlignment.Left}>
                    ...
                    <ul class="list-disc">
                        <li>
                            <Text alignment={TextAlignment.Left}>
                                Companies who support our Site and Services, such as Amazon Web Services.
                            </Text>
                        </li>
                        <li>
                            <Text alignment={TextAlignment.Left}>
                    ...
                    <Text alignment={TextAlignment.Left}>
                        Should you have any questions about our privacy practices or this Privacy Policy, or if you would like to exercise any of the rights available to you, please email us at hello@grammargrove.com.
                    </Text>
